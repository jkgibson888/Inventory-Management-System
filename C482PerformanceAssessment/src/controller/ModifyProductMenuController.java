...
public class ModifyProductMenuController implements Initializable {
    ...
    Product product = MainFormController.GetProduct();
    ...
    private void onActionAddPartsToListBtn(ActionEvent event) {
        ...
        try{
            ...
            */
            ...
            TableView.TableViewSelectionModel<Part> selectionModel = allPartsTableView.getSelectionModel();
    ...
    /**
     * Saves a product and its associated parts list with the appropriate changes made. 
    ...
    private void onActionSavePartsList(ActionEvent event) throws IOException {
        ...
        try{
            ...
            String sname = productNameTxt.getText();
            ...
            errorsList = checkFields.CheckFields(productNameTxt.getText(), priceTxt.getText(), inventoryLvlTxt.getText(), minTxt.getText(), maxTxt.getText());
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //set all fields
            ...
            inventoryLvlTxt.setText(String.valueOf(product.getStock()));
        ...
        PopulateTable(associatedParts, partsListTableView, addedPartIdCol, addedPartNameCol, addedPartInvCol, addPartPriceCol);
        
        System.out.println(Inventory.getAllParts().size());
        System.out.println(product.getAllAssociatedParts().size());
        
        int associatedPartsSize = associatedParts.size();
        
        //FIX ME set all parts table
            
         for(int i = 0; i < associatedParts.size(); ++ i){
             thisPartList.remove(associatedParts.get(i));
         }   
